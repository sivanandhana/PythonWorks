...
all_vehicle_name=[v.get("name") for v in vehicles]

print(all_vehicle_name)

all_brands={v.get("brand") for v in vehicles}

print(all_brands)

colour={v.get("name") for v in vehicles if v.get("color")=="Red"}

print(colour)

vehicle_name = {v.get("name")for v in vehicles if v.get("model")==2022}

print(vehicle_name)

diesel_vehicle = {v.get("name")for v in vehicles if v.get("fuel_type")=="Diesel"}

print(diesel_vehicle)


vehicle_price = {v.get("name")for v in vehicles if v.get("price")>1000000}
...
vehicles_name = {v.get("name")for v in vehicles if v.get("brand")=='Tata' and v.get("model")==2022}

print(vehicles_name)


maruthi_vehicles=[v.get('name') for v in vehicles if v.get("brand")=="Maruti Suzuki"]

print(maruthi_vehicles)


hyundai_vehicle=[v.get('name') for v in vehicles if v.get("brand")=="Hyundai" and v.get('price')>500000]

print(hyundai_vehicle)